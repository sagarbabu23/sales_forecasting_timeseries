...
library(xlsx)
airline <- read.xlsx(file.choose(),sheetIndex = 1) # read the Amtrack data
...
# multiplicative seasonality with linear trend has least RMSE value

new_model <- lm(Passengers~t+t_square+Jan+Feb+Mar+Apr+May+Jun+Jul+Aug+Sep+Oct+Nov,data=airdata)
